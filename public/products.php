...
<form method="GET" action="/products.php" class="row g-3 mb-4">
        ...
        <ul class="pagination justify-content-center">
            ...
            <?php if ($page > 1): ?>
                ...
                <li class="page-item">
                    <a
                        class="page-link"
                        href="?keyword=<?= urlencode($keyword) ?>&category=<?= $categoryID ?>&page=<?= $page - 1 ?>"
                    >
                        &laquo; Trước
                    </a>
                </li>
            ...
            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                ...
                <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                    ...
                    <a
                        class="page-link"
                        href="?keyword=<?= urlencode($keyword) ?>&category=<?= $categoryID ?>&page=<?= $i ?>"
                    >
                        <?= $i ?>
                    </a>
